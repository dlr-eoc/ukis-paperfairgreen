# Contributing to UKIS-paperfairgreen

Welcome to `UKIS-paperfairgreen`. We invite anyone to participate by contributing code, reporting
bugs, fixing bugs, writing documentation or discussing the future of this project. As a contributor,
...
Help us keep `UKIS-paperfairgreen` open and inclusive. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).
